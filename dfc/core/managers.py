...
class EmailUserManager(BaseUserManager):
	...
	def _create_user(self, email, password, is_staff, is_superuser, is_organization, **extra_fields):
		"""
		...
		user = self.model(email=email, is_staff=is_staff, is_superuser=is_superuser, 
			is_active=is_active, is_organization=is_organization, last_login=now, 
	...
	def create_user(self, email, password=None, **extra_fields):
		...
		return self._create_user(email, password, is_staff, False, is_organization, **extra_fields)
