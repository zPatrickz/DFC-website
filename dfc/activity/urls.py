...
urlpatterns = patterns('',
    ...
    url(r'^(?P<act_id>\d+)/doc/new',views.detail_doc_new, name = 'activity_detail_doc_new'),
    url(r'^(?P<act_id>\d+)/doc/(?P<doc_id>\d+)',views.detail_doc_detail, name = 'activity_detail_doc_detail'),
